...
[[ ! "${OPENCV_QUIET}" ]] && ( echo "Setting vars for OpenCV 4.1.0-dev" )
export DYLD_LIBRARY_PATH="$SCRIPT_DIR/../lib:$DYLD_LIBRARY_PATH"

if [[ ! "$OPENCV_SKIP_PYTHON" ]]; then
  PYTHONPATH_OPENCV="$SCRIPT_DIR/../Users/cwlroda/.virtualenvs/OpenCV-master-py3/lib/python3.7/site-packages"
